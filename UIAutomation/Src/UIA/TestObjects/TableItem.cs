...
namespace UIAutomation.Src.UIA.TestObjects
{
    ...
    public class TableItem : TestObjectBase, IValue
    {
        ...
        private TableItemPattern _tableItemPattern => TryGetCurrentPattern<TableItemPattern>();
        /// <summary>
        ...
        public int GetColumnIndex() => _tableItemPattern.Current.Column;

        public int GetRowIndex() => _tableItemPattern.Current.Row;
        //public Table GetContainer()
        //{
        //    if(AutoElement.GetCurrentPattern( GridItemPattern.Pattern ) is GridItemPattern gridItemPattern)
        //    {
        //        return new Table( gridItemPattern.Current.ContainingGrid );
        //    }
        //    else
        //    {
        //        if(AutoElement.GetCurrentPattern( TableItemPattern.Pattern ) is TableItemPattern tableItemPattern)
        //        {
